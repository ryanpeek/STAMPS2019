...
# load tkplot
library(tkrplot)
tkid <- tkplot(ig.mb) #tkid is the id of the tkplot that will open
...
# elist.gl     <- summary(triu(secor*getRefit(se.gl.amgut), k=1)) # doesn't work
...
# hist(elist.gl[,3], add=F, col='red') # this won't work
